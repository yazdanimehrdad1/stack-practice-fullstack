...
export declare const post: {
    ...
    <T_9>(method: DocumentMethod | DocumentMethod[], fn: PostArrayResponse<T_9>, options?: mongoose.SchemaPostOptions | undefined): ClassDecorator;
    <T_10>(method: DocumentMethod | DocumentMethod[], fn: PostArrayWithError<T_10>, options?: mongoose.SchemaPostOptions | undefined): ClassDecorator;
    <T_11>(method: QMR | QMR[], fn: PostQueryArrayResponse<T_11>, options?: mongoose.SchemaPostOptions | undefined): ClassDecorator;
    <T_12>(method: QMR | QMR[], fn: PostQueryArrayWithError<T_12>, options?: mongoose.SchemaPostOptions | undefined): ClassDecorator;
};
export declare const Pre: {
    <T>(method: AggregateMethod, fn: PreFnWithAggregate<T>, options?: mongoose.SchemaPreOptions | undefined): ClassDecorator;
    <T_1>(method: DR | DR[], fn: PreFnWithDocumentType<T_1>, options?: mongoose.SchemaPreOptions | undefined): ClassDecorator;
